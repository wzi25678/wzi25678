...
# 全量训练集
all_click_df = get_all_click_df(data_path, offline=False)       #offline=False模式下，直接从train_click_log.csv和testA_click_log.csv中读取数据
                                                                #offline=True模式下,则只从train_click_log.csv中读取数据
...
def get_item_topk_click(click_df, k):
    ...
    print('点击最多的{}个点击文章是：'.format(k),end='\n')
    print(topk_click)
    return topk_click
...
print(f"程序执行时间为: {execution_time} 秒")  #花费 1040.6612677574158 秒